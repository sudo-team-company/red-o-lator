...
#define clGetExtensionFunctionAddressForPlatform \
    _clGetExtensionFunctionAddressForPlatform_
...
#define clCreateBufferWithProperties _clCreateBufferWithProperties_
#define clCreateImageWithProperties _clCreateImageWithProperties_
#define clSetContextDestructorCallback _clSetContextDestructorCallback_
