...
/// Return from exception handler and continue. This instruction may only be used within a
/// trap handler.
...
void run_sop1(const Instruction& instr, Wavefront* wf) {
    ...
    switch (instr.get_key()) {
        ...
        case S_GETPC_B64:
            ...
            break;
        case S_ABS_I32: run_s_abs_i32(state); break;
        case S_AND_SAVEEXEC_B64: run_s_and_saveexec_b64(state); break;
        case S_ANDN1_SAVEEXEC_B64: run_s_andn1_saveexec_b64(state); break;
        case S_ANDN1_WREXEC_B64: run_s_andn1_wrexec_b64(state); break;
        case S_ANDN2_SAVEEXEC_B64: run_s_andn2_saveexec_b64(state); break;
        case S_ANDN2_WREXEC_B64: run_s_andn2_wrexec_b64(state); break;
        case S_BCNT0_I32_B32: run_s_bcnt0_i32_b32(state); break;
        case S_BCNT0_I32_B64: run_s_bcnt0_i32_b64(state); break;
        case S_BCNT1_I32_B32: run_s_bcnt1_i32_b32(state); break;
        case S_BCNT1_I32_B64: run_s_bcnt1_i32_b64(state); break;
        case S_BITREPLICATE_B64_B32: run_s_bitreplicate_b64_b32(state); break;
        case S_BITSET0_B32: run_s_bitset0_b32(state); break;
        case S_BITSET0_B64: run_s_bitset0_b64(state); break;
        case S_BITSET1_B32: run_s_bitset1_b32(state); break;
        case S_BITSET1_B64: run_s_bitset1_b64(state); break;
        case S_BREV_B32: run_s_brev_b32(state); break;
        case S_BREV_B64: run_s_brev_b64(state); break;
        case S_CMOV_B32: run_s_cmov_b32(state); break;
        case S_CMOV_B64: run_s_cmov_b64(state); break;
        case S_FF0_I32_B32: run_s_ff0_i32_b32(state); break;
        case S_FF0_I32_B64: run_s_ff0_i32_b64(state); break;
        case S_FF1_I32_B32: run_s_ff1_i32_b32(state); break;
        case S_FF1_I32_B64: run_s_ff1_i32_b64(state); break;
        case S_FLBIT_I32_B32: run_s_flbit_i32_b32(state); break;
        case S_FLBIT_I32_B64: run_s_flbit_i32_b64(state); break;
        case S_FLBIT_I32: run_s_flbit_i32(state); break;
        case S_FLBIT_I32_I64: run_s_flbit_i32_i64(state); break;
        case S_MOV_B32: run_s_mov_b32(state); break;
        case S_MOV_B64: run_s_mov_b64(state); break;
        case S_MOVRELD_B32: run_s_movreld_b32(state, wf); break;
        case S_MOVRELD_B64: run_s_movreld_b64(state, wf); break;
        case S_MOVRELS_B32: run_s_movrels_b32(state, wf); break;
        case S_MOVRELS_B64: run_s_movrels_b64(state, wf); break;
        case S_NAND_SAVEEXEC_B64: run_s_nand_saveexec_b64(state); break;
        case S_NOR_SAVEEXEC_B64: run_s_nor_saveexec_b64(state); break;
        case S_NOT_B32: run_s_not_b32(state); break;
        case S_NOT_B64: run_s_not_b64(state); break;
        case S_OR_SAVEEXEC_B64: run_s_or_saveexec_b64(state); break;
        case S_ORN2_SAVEEXEC_B64: run_s_orn2_saveexec_b64(state); break;
        case S_QUADMASK_B32: run_s_quadmask_b32(state); break;
        case S_QUADMASK_B64: run_s_quadmask_b64(state); break;
        case S_SEXT_I32_I8: run_s_sext_i32_i8(state); break;
        case S_SEXT_I32_I16: run_s_sext_i32_i16(state); break;
        case S_SWAPPC_B64: run_s_swappc_b64(state); break;
        case S_WQM_B32: run_s_wqm_b32(state); break;
        case S_WQM_B64: run_s_wqm_b64(state); break;
        case S_XNOR_SAVEEXEC_B64: run_s_xnor_saveexec_b64(state); break;
        case S_XOR_SAVEEXEC_B64: run_s_xor_saveexec_b64(state); break;
        default: UNSUPPORTED_INSTRUCTION("SOP1", get_mnemonic(instr.get_key()));
    }
